...
.. csv-table:: Configuration properties
    ...
    "gda.mx.hyperion.snapshot_directory", "string", "If this is a relative path, then this is resolved relative to the storage_directory for the collection. Otherwise it is interpreted as a prefix to which will be appended the
