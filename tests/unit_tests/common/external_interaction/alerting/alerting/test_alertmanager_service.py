...
@patch("mx_bluesky.common.external_interaction.alerting.alert_manager.requests.Session")
def test_alertmanager_alert(
    ...
    with session_cls() as session:
        ...
        assert actual_metadata[0]["generatorURL"] == (
            "https://graylog.diamond.ac.uk/streams/123456789/search?q=&rangetype=absolute&from=2025-05-22T11%3A49%3A23"
            ".123"
            "%2B00%3A00&to=2025-05-22T12%3A04%3A23.123%2B00%3A00"
        )
