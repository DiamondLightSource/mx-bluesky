...
def run_single_rotation_plan(
    ...
    **params,
    ...
    parameters = SingleRotationScan(
        ...
        omega_start_deg=params["omega_start_deg"],
        rotation_increment_deg=params["omega_increment_deg"],
        scan_width_deg=params["total_scan_width_deg"],
        detector_distance_mm=params["detector_distance_mm"],
        visit=params["visit"],
        file_name=params["file_name"],
        storage_directory=params["storage_directory"],
        shutter_opening_time_s=params["shutter_opening_time_s"],
        transmission_frac=params["transmission"],
