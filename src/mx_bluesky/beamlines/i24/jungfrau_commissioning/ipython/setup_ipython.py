...
async def create_rotation_composite() -> RotationScanComposite:
    with init_devices():
        ...
        jungfrau = i24.commissioning_jungfrau()
        gonio = i24.vgonio()
...
async def do_rotation(transmission=None):
    with open(
        "/dls_sw/i24/software/bluesky/jungfrau_25/mx-bluesky/src/mx_bluesky/beamlines/i24/jungfrau_commissioning/rotation_params.json"
    ) as f:
