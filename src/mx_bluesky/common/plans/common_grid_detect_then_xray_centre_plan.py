...
from mx_bluesky.common.parameters.common_gridscan import (
...
class GridDetectThenXRayCentreComposite(Protocol, Generic[TBeamstop]):
    ...
    def plan_to_perform():
        yield from ispyb_activation_wrapper(
            detect_grid_and_do_gridscan(
                composite, parameters, oav_params, flyscan_xrc_plan
            ),
            parameters,
        )
