...
class GridscanISPyBCallback(BaseISPyBCallback):
    ...
    def _get_scan_infos(self, doc) -> Sequence[ScanDataInfo]:
        ...
        for grid_num in range(self.params.num_grids):
            ...
            # todo the _get_scan_infos here should be vmxm specific since they require us asserting that params includes path_to_xtal_snapshot
            # and do this by asserting params are vmxm params
    ...
    def fill_gridscan_deposition_and_store(
        ...
        scan_data_infos: list[ScanDataInfo] = list(make_scan_infos_with_grid_info())
