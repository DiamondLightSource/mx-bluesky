...
class GridCommonWithHyperionDetectorParams(GridCommon, WithHyperionConfigServer):
    ...
    def detector_params(self):
        ...
        params.enable_dev_shm = self.config_server.get_feature_flags().USE_GPU_RESULTS
        return params
...
class HyperionSpecifiedThreeDGridScan(  # type: ignore
    ...
    def FGS_params(self) -> ZebraGridScanParams:
        return ZebraGridScanParams(
            ...
            set_stub_offsets=self.config_server.get_feature_flags().SET_STUB_OFFSETS,
    ...
    def panda_FGS_params(self) -> PandAGridScanParams:
        ...
        return PandAGridScanParams(
            ...
            z2_start_mm=self.z2_start_um / 1000,
            set_stub_offsets=self.config_server.get_feature_flags().SET_STUB_OFFSETS,
            run_up_distance_mm=self.config_server.get_feature_flags().PANDA_RUNUP_DISTANCE_MM,
            transmission_fraction=self.transmission_frac,
        )
