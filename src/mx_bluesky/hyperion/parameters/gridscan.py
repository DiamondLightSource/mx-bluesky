...
from dodal.common.general_maths.arithmetic_conversions import convert_microns_to_mm
...
def fast_gridscan_params(
    ...
    return ZebraGridScanParamsThreeD(
        ...
        x_step_size_mm=convert_microns_to_mm(grid_scan_params.x_step_size_um),
        y_step_size_mm=convert_microns_to_mm(grid_scan_params.y_step_sizes_um[0]),
        z_step_size_mm=convert_microns_to_mm(grid_scan_params.y_step_sizes_um[1]),
        x_start_mm=convert_microns_to_mm(grid_scan_params.x_start_um),
        y1_start_mm=convert_microns_to_mm(grid_scan_params.y_starts_um[0]),
        z1_start_mm=convert_microns_to_mm(grid_scan_params.z_starts_um[0]),
        y2_start_mm=convert_microns_to_mm(grid_scan_params.y_starts_um[1]),
        z2_start_mm=convert_microns_to_mm(grid_scan_params.z_starts_um[1]),
