...
def run_udc_when_requested(baton: Baton, runner: UDCRunner) -> MsgGenerator:
    ...
    def default_state_then_collect() -> MsgGenerator:
        yield from _move_to_default_state()
        yield from _main_hyperion_loop(baton, runner)
