...
def create_robot_unload_devices():
    ...
...
def robot_unload(
    visit: str,
    composite: RobotUnloadComposite = inject()
) -> MsgGenerator:
    """
    ...
    """
    yield from _robot_unload(composite.robot, composite.smargon, composite.aperture_scatterguard,
                             composite.lower_gonio, visit)
